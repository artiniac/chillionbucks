...
export function expandPark(state){
 ...
 const additions=[{type:'pool',x:30,z:0},{type:'pool',x:-30,z:0},{type:'bucket',x:30,z:-13},{type:'mushroom',x:-30,z:-13},{type:'icecream',x:29,z:14},{type:'burger',x:-29,z:14},{type:'umbrella',x:35,z:14},{type:'umbrella',x:-35,z:14}];
