...
const mount=new T.Vector3(0,1.025,.52),passengers=new T.Vector3(0,1.03,-.31);
...
export function interiorDashcam(body,aspect,position,target,up){
 ...
 return 2*T.MathUtils.radToDeg(Math.atan(Math.tan(T.MathUtils.degToRad(90/2))/aspect));
}
